...
class SDR_RS_HFIQ
{
    public:
        ...
        uint32_t    cmd_console(uint8_t * active_vfo, uint32_t * VFOA, uint32_t * VFOB, uint8_t * rs_curr_band, uint8_t * xmit, uint8_t * split); // active VFO value to possible change
